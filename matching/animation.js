...
let cardIndex = 0;
let cards = [
    { name: 'Peter', description: 'I amm a total mess person 24/7 party. Cleaning isnt my thing but always up for a good drink!', img: 'peter_messyguy.jpg'},
...
function loadCard(index) {
    ...
    $('.cards').append(`
        ...
        <div class="matching-image">
            <img src="images/${cards[index].img}" alt="peter_messyguy" width="100%" height="auto">
        </div>
